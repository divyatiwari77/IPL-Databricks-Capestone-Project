...
1. 🎯 Problem Statement
The Uncertainty in Cricket Analytics
...
Step 1: Ingestion (The Bronze Layer)
...
Step 2: Transformation & Cleaning (The Silver Layer)
Logic:
...
Step 3: Aggregation & Feature Engineering (The Gold Layer)
...
Why? It handles categorical variables (Stadium names, Team names) excellently and prevents overfitting better than a single Decision Tree.
Workflow:
...
B. Key Business Insights (Dashboard)
...
Create a Job that runs the notebooks in order: 01_Bronze -> 02_Silver -> 03_Gold -> 04_ML_Training.
